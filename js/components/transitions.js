        ...
        html += `
            <div class="transition-card">
                <div class="transition-header">
                    ...
                    <div style="flex: 1;">
                        <div class="gunasthan-name">${g.nameHi} <span style="font-weight: 400; color: #6b7280; font-size: 13px;">(${g.nameEn})</span></div>
                        ${g.descriptionHi ? `<div style="color: #4b5563; font-size: 13px; margin-top: 6px; line-height: 1.5; padding: 6px 10px; background: #f9fafb; border-left: 3px solid ${g.color}; border-radius: 3px;" data-speak-text="${g.nameHi}। ${g.descriptionHi.replace(/"/g, '&quot;')}">${g.descriptionHi}</div>` : ''}
                        <div style="color: #6b7280; font-size: 13px; margin-top: 6px; font-style: italic;">↪ ${rule.description}</div>
                        <div style="margin-top: 8px;">
                            <button class="speak-btn" data-speaks-id="trans-${i}"
                                    onclick="event.stopPropagation(); window.speakGunasthan(${i});">
